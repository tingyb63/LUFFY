...
- [ ] **luffy/verl/verl/mix_src/mix_vllm_rollout.py:44** - 1. support pp in vllm
- [ ] **luffy/verl/verl/mix_src/mix_vllm_rollout.py:45** - 2. passing tokenizer is not necessary? no encoding/decoding is happending here
- [ ] **luffy/verl/verl/mix_src/mix_vllm_rollout.py:46** - 3. simplify init logics
